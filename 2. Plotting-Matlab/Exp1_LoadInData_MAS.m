...
%cd /SchlossVRL/1.Organizing-R/Exp1-FasterLonger-Aliens-Labels
...
%Read in the RT data
n = length(FasterSubj);
LoadRTFast = zeros(16,20,n);  %16 condition rows, 20 columns of data
...
%Save Exp1 as .mat file into this folder
