...
#setwd("C:/Users/melan/Dropbox/Research/Experiments/ColormapWhat/Analyses/FasterLonger-Aliens-NoLabels")
setwd("~/Dropbox/ColormapWhat/Analyses/FasterLonger-Aliens-NoLabels")
