...
#FASTER/LONGER DATA with SOIL and Labels
...
#setwd("C:/Users/melan/Dropbox/Research/Experiments/ColormapWhat/Analyses/FasterLonger-Soil-Labels")
setwd("~/Dropbox/ColormapWhat/Analyses/FasterLonger-Soil-Labels")


#Load in SONA data
d <- read.csv("Exp4.csv") #Update me with name given when exporting from mySQL. 
varDescribe(d)
